...
class MergerConfig(object):
    ...
    def to_string(self, filename):
        ...
        r += f"锐化力度 blursharpen_amount: {self.blursharpen_amount}\n"
        return r

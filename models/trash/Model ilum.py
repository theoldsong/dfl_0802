    ...
    def on_initialize(self):
        ...
        with tf.device (models_opt_device):
            ...
            if self.is_training:
                ...
                if illum_power != 0:
                    self.D_illum_opt = nn.RMSprop(lr=lr, lr_dropout=lr_dropout, clipnorm=clipnorm, name='D_illum_opt')
        ...
        if self.is_training:
            ...
            for gpu_id in range(gpu_count):
                with tf.device( f'/GPU:{gpu_id}' if len(devices) != 0 else f'/CPU:0' ):
                    ...
                    if illum_power != 0:
                        ...
                        gpu_D_illum_loss_gvs += [ nn.gradients (gpu_D_illum_loss, self.D_illum.get_weights() ) ]
            ...
            with tf.device (models_opt_device):
                ...
                if illum_power != 0:
                    src_D_illum_loss_gv_op = self.D_illum_opt.get_update_op (nn.average_gv_list(gpu_D_illum_loss_gvs) )
